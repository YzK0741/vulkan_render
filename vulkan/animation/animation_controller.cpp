...
namespace vulkan {
    // animation_duration / display_name are module-private helpers declared in the interface
    // unit (animation_controller.cppm); the non-template members below use them from here.
